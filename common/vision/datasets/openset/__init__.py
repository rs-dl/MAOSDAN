...
def default_open_set(dataset_class: ClassVar, source: bool, source_domain_name, target_domain_name) -> ClassVar:
    """
    ...
    # elif dataset_class == RS:
    #     if source_domain_name == 'A' and target_domain_name == 'N':
    #         piblic_classes = 
    #         if source:
    #             private_classes = ()
    #         else:
